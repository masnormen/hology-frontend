    ...
    <>
      <div className="section-home-full-1">
        <div className="text">
          ...
          <div className="description">
            <Paragraph justify>
              House of Technology (HOLOGY) 3.0 merupakan acara dalam bidang IT yang diselenggarakan oleh Fakultas Ilmu
              Komputer Universitas Brawijaya dengan berkolaborasi bersama 9 organisasi dan komunitas di FILKOM. Tujuan
              HOLOGY hadir yaitu untuk mendorong inovasi, kreatifitas, dan juga meningkatkan jiwa kompetisi di
              antara mahasiswa, terutama dalam bidang teknologi informasi dan komunikasi. HOLOGY sendiri terdiri dari
              beberapa rangkaian, meliputi webinar, 6 cabang lomba, serta academy.
            </Paragraph>
          </div>
        </div>
      ...
      <div className="section-home-full-2">
        ...
        <div className="description fadeIn1">
          <Paragraph>
            HOLOGY 3.0 mengangkat tema "Accelerating Technological Revolution and Adaptability to Cultivate Better
            Digital Lifestyle", dengan tujuan agar mahasiswa Indonesia mampu membuat revolusi industri dengan
            menumbuhkan gaya hidup digital yang lebih baik serta beradaptasi dengan perkembangan zaman.
          </Paragraph>
        </div>
        ...
        <div className="description">
          <div className="text">
            <div className="header fadeIn3">
              <Paragraph header>Finding the best talents through competitions.</Paragraph>
            </div>
            <div className="sub-header fadeIn3">
              <Paragraph>
                Bergabung dan memecahkan tantangan di dalam kompetisi skala nasional bersama talenta IT dari seluruh
                penjuru Indonesia.
              </Paragraph>
            </div>
          </div>
          <div className="image-container fadeIn3">
            <Link to="/competition">
      ...
      <div className="section-home-full-5">
        ...
        <div className="description">
          <div className="tagline fadeIn4">
            <Paragraph>
              HOLOGY menyelenggarakan webinar seputar perkembangan dunia IT terkini. Stay tuned!
            </Paragraph>
          </div>
        ...
        <div className="description">
          ...
          <div className="text">
            <div className="header fadeIn5">
              <Paragraph header>Empowering IT enthusiasts through online courses.</Paragraph>
            </div>
