		...
		<>
			...
			<div className="section-home-full-2">
				<div className="title fadeIn1">
					<Header size="r">This Year's HOLOGY Theme</Header>
				</div>
				...
				<div className="description">
					<div className="text">
						<div className="header fadeIn3">
							<Paragraph header>HOLOGY Online Competition,<br/>Coming really soon for you!</Paragraph>
						</div>
			...
			<div className="section-home-full-5">
				...
				<div className="description">
					<div className="tagline fadeIn4">
						<Paragraph>
							Kami juga menyelenggarakan webinar seputar perkembangan dunia IT terkini.
						</Paragraph>
					</div>
				...
				<div className="description">
					...
					<div className="text">
						<div className="header fadeIn5">
							<Paragraph header>HOLOGY Online Academy,<br/>Coming really soon for you!</Paragraph>
						</div>
