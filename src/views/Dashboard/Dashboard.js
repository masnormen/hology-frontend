  ...
  return (
    <CheckSession redirect>
      ...
      <div className="dashboard-container-full">
        ...
        <br/>
        <Paragraph>
          Pengumuman: Semua tim batch 1 yang belum terverifikasi persyaratan berkasnya sampai akhir periode batch 1 akan
          dihapus secara otomatis oleh sistem. Apabila tim Anda dihapus, Anda diharuskan membuat tim lagi untuk
          mengikuti pendaftaran batch 2.
        </Paragraph>
