      ...
      <div className="dashboard-section-webinar">
        {getUserData != null && getUserData.user_register_in_webinar ? (
          <>
            ...
            {Date.now() > Date.parse("2020-10-30T18:29:59.000+07:00") ? (
              <>
                <br />
                <br />
                <a
                  ...
                  href="https://youtu.be/T6qR-5laRlg"
                >
                ...
                <div className="livestream">
                  <iframe
                    id="video"
                    src="https://www.youtube.com/embed/T6qR-5laRlg"
                    frameBorder="0"
                  ...
                  <iframe
                    id="comment"
                    src="https://www.youtube.com/live_chat?v=T6qR-5laRlg&embed_domain=hology.ub.ac.id"
                    frameBorder="0"
